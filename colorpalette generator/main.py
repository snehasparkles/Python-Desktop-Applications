...
Label(root,width=120,height=10,bg="#944E63").pack()
...
id10 = colors2.create_rectangle((10,200,50,250),fill="#14aafd")
...
hex10 = Label(colors2,text="#14aafd",fg="#000",font="arial 12 bold",bg="white")
